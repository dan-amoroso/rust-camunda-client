...
pub trait ProcessDefinitionApi {
    ...
    ) -> Result<Vec<crate::models::ActivityStatisticsResultDto>, Error>;
    ...
    fn get_latest_process_definition_by_tenant_id(
        ...
        key: &str,
        tenant_id: &str,
    ) -> Result<crate::models::ProcessDefinitionDto, Error>;
    ...
    fn get_process_definition_bpmn20_xml(
        &self,
        id: &str,
    ) -> Result<crate::models::ProcessDefinitionDiagramDto, Error>;
    ...
    fn get_process_definition_diagram_by_key(&self, key: &str)
        -> Result<std::path::PathBuf, Error>;
    ...
    ) -> Result<Vec<crate::models::ProcessDefinitionStatisticsResultDto>, Error>;
    ...
    ) -> Result<Vec<crate::models::ProcessDefinitionDto>, Error>;
    fn get_process_definitions_count(
        ...
        not_startable_in_tasklist: Option<bool>,
        startable_permission_check: Option<bool>,
    ) -> Result<crate::models::CountResultDto, Error>;
    ...
    fn get_start_form_by_key_and_tenant_id(
        ...
        key: &str,
        tenant_id: &str,
    ) -> Result<crate::models::FormDto, Error>;
    fn get_start_form_variables(
        &self,
        id: &str,
        variable_names: Option<&str>,
        deserialize_values: Option<bool>,
    ) -> Result<::std::collections::HashMap<String, crate::models::VariableValueDto>, Error>;
    ...
    ) -> Result<crate::models::ProcessInstanceDto, Error>;
...
impl ProcessDefinitionApi for ProcessDefinitionApiClient {
    ...
    fn get_process_definitions(
        ...
        let uri_str = format!("{}/process_definition", configuration.base_path);
        let mut req_builder = client.get(uri_str.as_str());
        ...
        if let Some(ref s) = include_process_definitions_without_tenant_id {
            req_builder =
                req_builder.query(&[("includeProcessDefinitionsWithoutTenantId", &s.to_string())]);
        }
